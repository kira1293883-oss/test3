...
; ==============================================================================
LagreNyeHurtigtaster(g, p1, p2, p3, p4, p5, p6, p7, p8) {
    global HK_Pause, HK_Extract, HK_Gui, HK_Speed, HK_Lock, HK_Round, HK_SaveNote, HK_Link
    gamleKnapper := [HK_Pause, HK_Extract, HK_Gui, HK_Speed, HK_Lock, HK_Round, HK_SaveNote, HK_Link]
    for k in gamleKnapper {
        try Hotkey(k, "Off")
    }
    try {
        global HK_Pause := p1, HK_Extract := p2, HK_Gui := p3, HK_Speed := p4, HK_Lock := p5, HK_Round := p6, HK_SaveNote := p7, HK_Link := p8
