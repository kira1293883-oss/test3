...
TriggerF1Knappeoppsett() {
    global HK_Pause, HK_Extract, HK_Gui, HK_Speed, HK_Lock, HK_Round, HK_SaveNote, HK_Link, cfg
    ...
    try {
        ...
        cfg.Add("Button", "w270 h32 xm y+20 -Theme +Background3A3A3A", "💾 Lagre Knapper").OnEvent("Click", (btn, *)=>LagreNyeHurtigtaster(cfg, iP.Value, iE.Value, iG.Value, iFart.Value, iLock.Value, iRound.Value, iSave.Value, iLink.Value))
        cfg.Add("Button", "w270 h32 xm y+10 -Theme +Background3A3A3A", "🔄 Reset Standard").OnEvent("Click", (btn, *)=>LagreNyeHurtigtaster(cfg, "F2", "F3", "F11", "F7", "^!l", "^!r", "^!s", "^!u"))
